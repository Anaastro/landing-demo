									...
									<div className="space-y-4">
										...
										<div className="p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800 space-y-4">
											<div className="flex items-center gap-3">
												<input
													type="checkbox"
													id={`whatsapp-enabled-${product.id}`}
													checked={product.whatsapp?.enabled || false}
													onChange={(e) => {
														const newProducts = [...content.products.products];
														newProducts[index] = {
															...newProducts[index],
												...
												/>
												<label
													htmlFor={`whatsapp-enabled-${product.id}`}
											...
											{product.whatsapp?.enabled && (
												<>
													<div>
														<label className="block text-sm font-medium mb-2">
															...
															<span className="text-xs text-muted-foreground ml-2">
																(con código de país, ej: 34612345678)
															</span>
														</label>
														<input
															type="tel"
															value={product.whatsapp?.phoneNumber || ""}
															onChange={(e) => {
																const newProducts = [
																	...content.products.products,
																];
															...
															className="w-full px-4 py-2 border border-border rounded-lg bg-background dark:bg-muted focus:outline-none focus:ring-2 focus:ring-green-500"
														/>
													</div>
													...
													<div>
														...
														<textarea
															value={product.whatsapp?.message || ""}
															onChange={(e) => {
																const newProducts = [
																	...content.products.products,
																];
															...
															placeholder={`Hola, estoy interesado en el plan ${product.name}`}
															rows={3}
															className="w-full px-4 py-2 border border-border rounded-lg bg-background dark:bg-muted focus:outline-none focus:ring-2 focus:ring-green-500 text-sm"
														/>
													</div>
												</>
											)}
								...
								onClick={() => {
									const newProduct = {
										...
										whatsapp: {
											enabled: false,
											phoneNumber: "",
											message: "Hola, estoy interesado en este plan",
										},
									};
									setContent({
										...content,
